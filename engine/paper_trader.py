...
def _load_etf_names() -> dict:
    """从 ETF 池子配置文件动态加载名称映射"""
    import json as _json
    pool_path = Path(__file__).parent.parent / "data" / "etf_pool.json"
    if pool_path.exists():
        try:
            return _json.loads(pool_path.read_text(encoding="utf-8"))
        except Exception:
            pass
    return {"510050": "上证50", "510300": "沪深300", "510500": "中证500",
            "159915": "创业板", "588000": "科创50", "512880": "证券",
            "512010": "医药", "512690": "酒/消费", "510880": "红利",
            "511010": "国债", "159941": "纳指ETF", "513100": "纳指100",
            "562500": "机器人", "518880": "黄金ETF", "159819": "AI智能",
            "159930": "能源ETF"}
